...
<nav>
  ...
  <div class="form-row align-items-center">
    ...
    <div class="col-md-2 my-1">
      ...
      <input type="text" style="width: 130px !important; " class="form-control" id="inlineFormInputName" placeholder="Jane Doe">
    </div>
    <div class="col-md-2 my-1">
      <label class="sr-only" for="inlineFormInputName">Where</label>
    ...
    <div class="col-auto my-1">
      <button type="submit" style="background-color:red; outline:none !important; " class="btn btn-primary">Search</button>
    </div>
  </div>
</form>
  ...
  <div class="carousel-inner">
    ...
    <div class="carousel-item">
      <img src="images/greece1.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images/maldiv.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images/rome.jpg" class="d-block w-100" alt="...">
    </div>
    <div class="carousel-item">
      <img src="images/swiss.png" class="d-block w-100" alt="...">
    </div>
  </div>
...
<section style=" margin-top:50px; margin-bottom: 60px">
  ...
  <div class="column2">
    <img  src="images/rome.jpg" alt="Snow" style="width:100%; ">
  </div>
  <div class="column2">
    <img src="images/rome.jpg" alt="Forest" style="width:100%">
  </div>
  <div class="column2">
    <img src="images/rome.jpg" alt="Mountains" style="width:100%">
  </div>
  <div class="column2">
    <img src="images/rome.jpg" alt="Mountains" style="width:100%">
  </div>
...
<footer>
  <div class="foot" style="background-color:#090736; width: 100%; padding-top:7px; padding-left: 20%">
  <p style="color: white; padding-top: 5px;padding-bottom: 5px; font-size: 0.8rem; text-align: center">  You can be informed of all our opportunities! </p>
  <div class="input-group mb-3" style="width: 360px; padding-left: 5px;">
  ...
  <div class="row3">
    <div class="column3">
    <p>  © 2018 THE COPYRIGHT OF ALL THE
      VISUAL MATERIALS AND ALL CONTENTS
      IN THE SITE BELONG TO MYBOX.</p>
    </div>
    <div class="column3">
    <ul>
      <li>HOTEL</li>
